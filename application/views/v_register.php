				...
				<div class="card card-signin my-5">
					<div class="card-body">
						...
						<h5 class="card-title text-center"><strong>Sign In<strong></h5>
							<form method="post" action="<?php echo site_url('register/new_user')?>">
								...
								<div class="form-group">
									<input type="text" name="name" id="name" class="form-control input-lg" placeholder="Nama" tabindex="2">
								</div>
								<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-xs-12 col-md-6"><a class="btn btn-success btn-block btn-lg">Sign In</a></div>
								</div>
							</form>
							<div class="card-title text-center">
